...
function Login(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'user__form-group' },
      _react2.default.createElement('input', { className: 'user__input', id: 'password', name: 'password', type: 'password', placeholder: 'Password', onChange: handleInputChange, value: password }),
      _react2.default.createElement(
        'label',
